          ...
          {tokenize(line).map((token, tokenIndex) => (
            <span
              ...
              className={
                ...
                token.type === 'class' ? 'text-orange-600' :
                'text-gray-800'
              }
            >
              {token.text}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex space-x-4 lg:space-x-8">
              <Link href="/docs" className="text-orange-600 hover:text-orange-700 px-3 py-2 text-sm font-medium flex items-center transition-colors">
              ...
              <Link href="https://github.com/AkronORM/Akron" className="text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium flex items-center transition-colors">
          ...
          <div className="fixed inset-y-0 left-0 w-64 bg-white shadow-lg z-50 overflow-y-auto">
            <div className="p-6">
              ...
              <div className="mb-6 md:hidden">
                <Link href="/docs" className="block text-orange-600 hover:text-orange-700 px-3 py-2 text-sm font-medium mb-2 transition-colors" onClick={() => setSidebarOpen(false)}>
                  📖 Documentation
                </Link>
                <Link href="https://github.com/AkronORM/Akron" className="block text-gray-700 hover:text-gray-900 px-3 py-2 text-sm font-medium transition-colors" onClick={() => setSidebarOpen(false)}>
                  💻 GitHub
                </Link>
              </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="max-w-4xl">
              <div className="mb-4 lg:mb-6">
                <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 mb-2 lg:mb-3 leading-tight">{title}</h1>
                {description && (
                  <p className="text-sm sm:text-base lg:text-lg text-gray-600 leading-relaxed">{description}</p>
                )}
              </div>
              <div className="prose prose-sm sm:prose lg:prose-lg max-w-none prose-headings:scroll-mt-24 prose-headings:font-bold prose-gray">
                {children}
              </div>
            </div>
          </div>
    ...
    <>
      <div className="pb-4">
        ...
        <ul className="mt-2 space-y-1">
          <li><Link href="/docs/getting-started/installation" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>Installation</Link></li>
          <li><Link href="/docs/getting-started/quick-start" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>Quick Start</Link></li>
          <li><Link href="/docs/getting-started/basic-usage" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>Basic Usage</Link></li>
        </ul>
      </div>
      ...
      <div className="pb-4">
        ...
        <ul className="mt-2 space-y-1">
          <li><Link href="/docs/api/create-table" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>create_table()</Link></li>
          <li><Link href="/docs/api/insert" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>insert()</Link></li>
          <li><Link href="/docs/api/find" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>find()</Link></li>
          <li><Link href="/docs/api/update" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>update()</Link></li>
          <li><Link href="/docs/api/delete" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>delete()</Link></li>
          <li><Link href="/docs/api/close" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>close()</Link></li>
          <li><Link href="/docs/api/transaction" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>transaction()</Link></li>
        </ul>
      </div>
      ...
      <div className="pb-4">
        ...
        <ul className="mt-2 space-y-1">
          <li><Link href="/docs/cli/create-table" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>create-table</Link></li>
          <li><Link href="/docs/cli/drop-table" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>drop-table</Link></li>
          <li><Link href="/docs/cli/seed" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>seed</Link></li>
          <li><Link href="/docs/cli/inspect-schema" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>inspect-schema</Link></li>
          <li><Link href="/docs/cli/makemigrations" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>makemigrations</Link></li>
          <li><Link href="/docs/cli/migrate" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>migrate</Link></li>
          <li><Link href="/docs/cli/raw-sql" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>raw-sql</Link></li>
        </ul>
      </div>
      ...
      <div className="pb-4">
        ...
        <ul className="mt-2 space-y-1">
          <li><Link href="/docs/database-support/sqlite" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>SQLite</Link></li>
          <li><Link href="/docs/database-support/mysql" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>MySQL</Link></li>
          <li><Link href="/docs/database-support/postgresql" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>PostgreSQL</Link></li>
          <li><Link href="/docs/database-support/mongodb" className="text-gray-600 hover:text-orange-600 text-sm block py-1 transition-colors" onClick={onLinkClick}>MongoDB</Link></li>
        </ul>
      </div>
